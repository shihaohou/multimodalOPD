...
VLLM_MM_PROCESSOR_KWARGS="${VLLM_MM_PROCESSOR_KWARGS:-}"
DTYPE="${DTYPE:-auto}"
...
[[ -n "$VLLM_MAX_NUM_BATCHED_TOKENS" ]] && CMD+=(--max-num-batched-tokens "$VLLM_MAX_NUM_BATCHED_TOKENS")
[[ -n "$VLLM_MM_PROCESSOR_CACHE_GB" ]] && CMD+=(--mm-processor-cache-gb "$VLLM_MM_PROCESSOR_CACHE_GB")
[[ -n "$VLLM_MM_PROCESSOR_KWARGS" ]] && CMD+=(--mm-processor-kwargs "$VLLM_MM_PROCESSOR_KWARGS")
