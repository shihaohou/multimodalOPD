...
OUTPUT_DIR="${OUTPUT_DIR:-runs/vigos_qwen25_7b_${RUN_ID}}"
...
RUN_CONFIG="${RUN_CONFIG:-vigos_qwen25_7b_gen${MAX_COMPLETION_LENGTH}_mb${PER_DEVICE_TRAIN_BATCH_SIZE}_ga${GRADIENT_ACCUMULATION_STEPS}_np${NUM_PROCESSES}_tp${VLLM_TENSOR_PARALLEL_SIZE}_vllm_${VLLM_MODE}}"
...
uv run accelerate launch \
  ...
  --run_name "vigos_qwen25_7b_${RUN_ID}" \
